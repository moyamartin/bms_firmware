...
enum BQ76_status {
	BQ76_OK = 0,
	BQ76_SPI_TRANSMISSION_ERROR = -1,
	BQ76_BROADCAST_RESET_FAIL = -2,
	BQ76_DEVICE_RESET_FAIL = -3,
	BQ76_ADDRESS_CONFIG_FAIL = -4,
	BQ76_ADC_CONFIG_FAIL = -5,
	BQ76_CB_TIME_CONFIG_FAIL = -6,
	BQ76_FUNCTION_CONFIG_FAIL = -7,
	BQ76_IO_CONFIG_FAIL = -8,
	BQ76_COV_CONFIG_FAIL = -9,
	BQ76_COVT_CONFIG_FAIL = -10,
	BQ76_CUV_CONFIG_FAIL = -11,
...
enum BQ76_status bq76_init(struct BQ76 * device, uint8_t spi_address,
						   uint8_t balancing_time,
						   float32_t cov_threshold, uint8_t covt_delay,
						   float32_t cuv_threshold, uint8_t cuvt_delay,
						   float32_t temp1_threshold, float32_t temp2_threshold,
						   uint16_t temp_delay);
